        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl border border-gray-200 p-8">
                    ...
                    <form action="{{ route('checkout.process', ['plan' => $plan->slug]) }}" method="POST" class="space-y-8">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                {{-- SSL Commerz --}}
                                <label class="relative flex items-start p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-indigo-300 hover:bg-indigo-50 transition-colors">
                                    <input type="radio" name="payment_method" value="ssl_commerz" checked
                                           class="mt-1 w-4 h-4 text-indigo-600 cursor-pointer">
                                    <div class="ml-4 flex-grow">
                                        <p class="font-semibold text-gray-900">SSL Commerz</p>
                                        <p class="text-sm text-gray-500">Card, bKash, Nagad, Bank Transfer</p>
                                    </div>
                                </label>

                                {{-- Placeholder for future gateways --}}
                                <div class="p-4 border border-gray-200 rounded-lg opacity-50 cursor-not-allowed">
                                    <p class="font-semibold text-gray-500">Other Methods (Coming Soon)</p>
                                    <p class="text-sm text-gray-400">Direct bank transfer, offline payment</p>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="bg-white rounded-2xl border border-gray-200 p-6 sticky top-8">
                    ...
                    <div class="space-y-3 mb-6 pb-6 border-b border-gray-200">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-900">
                                <span class="monthly-price">${{ number_format($plan->price_monthly / 100, 2) }}</span>
                                <span class="yearly-price hidden">${{ number_format($plan->price_yearly / 100, 2) }}</span>
                            </span>
                        </div>
                    ...
                    <p class="text-xs text-gray-500 mt-4 text-center">
                        <span class="monthly-period">Billed monthly</span>
                        <span class="yearly-period hidden">Billed yearly</span>
                    </p>
