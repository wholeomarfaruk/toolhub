...
<head>
    <meta charset="UTF-8">
    <title>Character Counter Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Character Counter Analysis Report</h1>
    ...
    {{-- Main Metrics --}}
    <div class="section">
        <div class="section-title">Character & Content Metrics</div>
    ...
    <div class="footer">
        <p>{{ config('app.name', 'ToolsHub') }} Character Counter | Generated by {{ config('app.name', 'ToolsHub') }}</p>
    </div>
</body>
</html>
