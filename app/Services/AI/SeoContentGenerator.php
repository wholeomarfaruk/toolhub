...
class SeoContentGenerator
{
    ...
    public function generate(string $providerSlug, SeoKeyword|string $keywordOrTopic, string $toolName, string $toolSlug, array $variables = [], array $toolPreset = [], ?string $model = null): array
    {
        $system = <<<PROMPT
