...
class SentenceCounter extends Component
{
    use WithToolAccess;
    use WithToolRateLimit;
    use WithUsageTracking;

    public string $toolSlug = 'sentence-counter';
    ...
    public function analyze(): void
    {
        ...
        $this->result = app(SentenceCounterTool::class)->run([
            'text' => $this->text,
        ]);
    ...
    public function exportPdf()
    {
        ...
        return redirect(route('sentence-counter.pdf'));
    }
