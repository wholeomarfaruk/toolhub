...
return new class extends Migration
{
    ...
    {
        $exists = DB::table('seo_pages')
            ->where('tool_slug', 'age-calculator')
            ->where('slug', 'accurate-age-calculator-for-legal-purposes')
            ->exists();
        ...
        DB::table('seo_pages')->insert([
            ...
            'tool_preset' => json_encode(['dob' => '2000-01-01']),
